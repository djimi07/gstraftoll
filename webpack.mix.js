...
mixAssetsDir('vendors/js/marketing/**/*.js', (src, dest) => mix.scripts(src, dest))
mixAssetsDir('vendors/css/**/*.css', (src, dest) => mix.copy(src, dest))
mixAssetsDir('vendors/css/marketing/css/**/*.css', (src, dest) => mix.copy(src, dest))
...
mixAssetsDir('vendors/css/marketing/fonts/', (src, dest) => mix.copy(src, dest))
