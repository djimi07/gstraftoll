...
use App\Http\Controllers\Core\AnprCaptureController;
use App\Http\Controllers\Core\DashboardController;
use App\Http\Controllers\Core\GeneralController;
use App\Http\Controllers\Core\HackneyController;
use App\Http\Controllers\Core\InvoicesController;
use App\Http\Controllers\Core\PaymentsController;
use App\Http\Controllers\Core\PublicController;
use App\Http\Controllers\Core\RevenueController;
use App\Http\Controllers\Core\SmsController;
...
// Main Page Route
//Route::get('/get-hackney', [HackneyController::class, 'createInvoiceLanding'])->name('landing');
Route::match(['get','post'],'/get-hackney', [PublicController::class, 'showInvoiceForms'])->name('landing.invoices');
Route::get('/', [PublicController::class, 'homePage'])->name('homepage');
Route::get('/login', [LoginController::class, 'showLoginForm'])->name('loginForm');
Route::post('authenticate', [LoginController::class, 'authenticate'])->name('authenticate');
Route::get('dashboard', [DashboardController::class, 'dashboardAnalytics'])->name('dashboard')->middleware('auth');
Route::get('/invoice/pdf',[PublicController::class,'pdfView'])->name('invoice.pdf');
...
Route::prefix('v1')
    ...
    ->middleware('auth')->group(function ()
    {
        ...
        Route::get('/recent-capture', [AnprCaptureController::class, 'apiListRecent'])->name('capture.recent');
        Route::get('/list-capture', [AnprCaptureController::class, 'apiList'])->name("capture.list");
        Route::get('/capture/view/{id}', [AnprCaptureController::class, 'getCapture'])->name("capture.view");

        Route::get('/list-roles', [RoleController::class, 'apiList'])->name("roles.list");

        Route::get('/list-vehicles', [VehicleController::class, 'apiList'])->name("vehicle.list");
        Route::post('/vehicle/register/applicants', [VehicleController::class, 'apiVehicleApplicants'])->name('vehicle.createApplicant');
        Route::post('/vehicle/register/documents', [VehicleController::class, 'apiVehicleDocuments'])->name('vehicle.createDocument');
        Route::post('/vehicle/edit/applicants/{id}', [VehicleController::class, 'editApplicant'])->name('vehicle.editApplicant');
        Route::post('/vehicle/edit/documents/{id}', [VehicleController::class, 'editDocuments'])->name('vehicle.editDocument');
        Route::get('/vehicle/delete/{id}', [VehicleController::class, 'apiVehicleDelete'])->name('vehicle.deleteVehicle');
        Route::get('/vehicle/edit/{id}', [VehicleController::class, 'edit'])->name('vehicle.edit');
        Route::get('/vehicle/view/{id}', [VehicleController::class, 'apiGetVehicle'])->name('vehicle.view');


        Route::get('/list-invoices', [InvoicesController::class, 'listInvoiceApi'])->name("invoice.list");

        Route::post('/sms/create', [SmsController::class, 'createSms'])->name("sms.create");
        Route::get('/list-sms', [SmsController::class, 'listSmsApi'])->name("sms.list");

        Route::get('/list-payments', [PaymentsController::class, 'listPaymentApi'])->name("payment.list");


        Route::get('/list-users', [UserController::class, 'users_get'])->name("user.list");
        ...
        Route::get('/user/edit/{id}', [UserController::class, 'edit'])->name('edit')->name("user.edit");
        Route::post('/user/edit/{id}', [UserController::class, 'editSubmit'])->name('edit');
   ...
   ->group(function ()
    {
        ...
        Route::get('/get-lgas', [GeneralController::class, 'listLgasApi'])->name("general.listLgas");

        Route::get('/get-revenue-heads', [GeneralController::class, 'listRevenueHeadsApi'])->name("general.listRevenueHeads");
        Route::get('/get-revenue-items', [GeneralController::class, 'listRevenueItemsApi'])->name("general.listRevenueItems");
        Route::get('/get-revenue-items/{id}', [GeneralController::class, 'getRevenueItemByIdApi'])->name("general.getRevenueItem");

        Route::post('/invoices/create', [InvoicesController::class, 'createInvoice'])->name("invoice.create");
...
Route::prefix('captures')
    ->name('capture')
    ->middleware('auth')->group(function ()
    {
        Route::get('/view/{id}', [AnprCaptureController::class, 'captureView'])->name("view");

        Route::get('/', [AnprCaptureController::class, 'list'])->name("list");
    });
...
Route::prefix('vehicles')
    ...
    ->middleware('auth')->group(function ()
    {
        ...
        Route::get('/', [VehicleController::class, 'list'])->name("list");
        Route::get('/register', [VehicleController::class, 'register'])->name("register");
...
Route::prefix('hackney')
    ->name('hackney.')
    ->middleware('auth')->group(function ()
    {

        Route::get('/', [VehicleController::class, 'list'])->name("list");
        Route::get('/buy', [HackneyController::class, 'createInvoice'])->name("buy");
    });
...
Route::prefix('invoices')
    ...
    ->middleware('auth')->group(function ()
    {
        Route::get('/', [InvoicesController::class, 'listInvoices'])->name("list");
        Route::get('/create/', [InvoicesController::class, 'create'])->name("new");
        Route::get('/create/compliance', [InvoicesController::class, 'createInvoiceCompliance'])->name("create.compliance");
        Route::get('/create/violations', [InvoicesController::class, 'createInvoiceViolation'])->name("create.violations");
        Route::get('/preview/{id}', [InvoicesController::class, 'previewInvoice'])->name("preview");
        Route::get('/print/{id}', [InvoicesController::class, 'printInvoice'])->name("print");
...
Route::prefix('sms')
    ...
    ->middleware('auth')->group(function ()
    {
        Route::get('/', [SmsController::class, 'listSms'])->name("list");
        Route::get('/create', [SmsController::class, 'create'])->name("new");
...
Route::prefix('payments')
    ...
    ->middleware('auth')->group(function ()
    {
        Route::get('/', [PaymentsController::class, 'listPayments'])->name("list");
        Route::get('/preview/{id}', [PaymentsController::class, 'previewPayment'])->name("preview");
        Route::get('/print/{id}', [PaymentsController::class, 'printPayment'])->name("print");

    });
Route::prefix('revenue-head')
    ->name('revenue-head')
    ->middleware('auth')->group(function ()
    {
        Route::get('/', [RevenueController::class, 'headList'])->name("revenueHead");
        Route::post('/', [RevenueController::class, 'submitRevenueHead'])->name("submitRevenueHead");
        Route::delete('/', [RevenueController::class, 'deleteRevenueHead'])->name("deleteRevenueHead");
        Route::get('/list', [RevenueController::class, 'getRevenueHeadList'])->name("getRevenueHeadList");
    });

Route::prefix('revenue-item')
    ->name('revenue-item')
    ->middleware('auth')->group(function ()
    {
        Route::get('/', [RevenueController::class, 'itemList'])->name("revenueItem");
        Route::post('/', [RevenueController::class, 'submitRevenueItem'])->name("submitRevenueItem");
        Route::delete('/', [RevenueController::class, 'deleteRevenueItem'])->name("deleteRevenueItem");
        Route::get('/list', [RevenueController::class, 'getRevenueItemList'])->name("getRevenueItemList");
    });
...
action: fn() => redirect()
        ->route('login')
        ->with('msg:info', 'Please try your last action/ again')
);
Auth::routes(); /* Route Apps */
...
Route::group(['prefix' => 'page'], function ()
{
    ...
    Route::get('knowledge-base/category/question', [PagesController::class, 'kb_question'])->name('page-knowledge-base-que');
