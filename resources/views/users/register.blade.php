...
<section class="app-user-list">
  ...
  <div class="row">
    <div class="col-12">
        <a id="add_user_button" href="#" data-toggle="modal" data-target="#modals-slide-in" class="btn btn-icon btn-primary waves-effect waves-float waves-light" type="button" data-repeater-create="">
  ...
  <div class="card">
    <div class="card-header">
      <h4 class="card-title">GSTraftoll Registered Users</h4>
    </div>
