...
@section('title', 'Invoice Violation')
    ...
    <section class="modern-horizontal-wizard">
        <div class="bs-stepper wizard-modern modern-wizard-example">
          ...
          <span class="bs-stepper-box">
            ...
            <span class="bs-stepper-subtitle">Enter <Violation></Violation>  Information</span>
          </span>
                    </button>
                </div>
                <div class="line">
                ...
                <div id="account-details-modern" class="content">
                   ...
                   <input type="hidden" id="vehicleId" value="{{$vehicleId}}" />
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <label class="form-label" for="revenueHeadCode">Revenue Head</label>


                                <select required name="revenueHeadCode" id="revenueHeadCode" class="form-control
                                item-details">
                                    <option value="">--Select--</option>
...
@section('page-script')
    <!-- Page js files -->
    <script src="{{ asset(mix('js/scripts/forms/new-invoice-form-violation.js')) }}"></script>
@endsection
