...
@section('title', 'Invoice Compliance')
    ...
    <section class="modern-horizontal-wizard">
        <div class="bs-stepper wizard-modern modern-wizard-example">
          ...
          <span class="bs-stepper-box">
            ...
            <span class="bs-stepper-subtitle">Enter Compliance  Information</span>
          </span>
                    </button>
                </div>
                <div class="line">
...
@section('page-script')
    <!-- Page js files -->
    <script src="{{ asset(mix('js/scripts/forms/new-invoice-form-compliance.js')) }}"></script>
@endsection
