...
@section('title', 'GS Traftroll Dashboard')
      ...
      <div class="card card-congratulations">
        <div class="card-body text-center">
          ...
          <div class="text-center">
            ...
            <h1 class="mb-1 text-white">Hello,  {{Auth::user()->fullName}}.</h1>
    ...
    <div class="col-lg-3 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start pb-0">
          ...
          <p class="card-text">Vehicles Captured</p>
        </div>
    ...
    <div class="col-lg-3 col-sm-6 col-12">
      <div class="card">
        <div class="card-header flex-column align-items-start pb-0">
          ...
          <p class="card-text">Offences Booked</p>
        </div>
          ...
          <table class="invoice-list-table table">
            <thead>
              <tr>
                  ...
                  <th>Location</th>
                  <th>Country</th>
                <th class="text-truncate">Capture Date</th>
                <th>Registered?</th>
                <th>Reg. Expired?</th>
                 <th></th>
                 <th></th>
...
@section('page-script')
  ...
  <script src="{{ asset(mix('js/scripts/pages/vehicle-log-list.js')) }}"></script>
@endsection
