...
@section('title', 'GSTraftoll Login Page')
...
@section('content')
        ...
        <div class="auth-inner row m-0">
            ...
            <a class="brand-logo" href="{{route('homepage')}}">
                ...
                <h2 class="brand-text text-primary ml-1">GS Traftoll </h2>
            </a>
            <!-- /Brand logo-->
            ...
            <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                    <h2 class="card-title font-weight-bold mb-1"> GSTraftoll</h2>
                    ...
                    <form class="auth-login-form mt-2" action="{{ route('authenticate') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('email') is-invalid @enderror"
                                   id="login-email" name="email" placeholder="chinedu@airs.ng"
