$(function () {
    ...
    $.ajax(
        {
            url: GsTraftoll.url('v1/get-revenue-items?code=' + $('#revenueHeadCode').val()),
            success: function (result) {
                // console.log(result);
    ...
    function gotoHomePage(message,data) {
        console.log("created invoices");
        console.log(data);

        window.location.href = "/invoice/pdf?id="+ data.id ;
    }


    $("#hackneySubmit").click(function (e) {
        //progress...
            ...
            $.post({
                ...
                success: function (response) {
                    ...
                    if (response.status == 201) {
                        window.setTimeout(gotoHomePage("invoice.created",response.data), 4000);

                    } else {
                        window.setTimeout(gotoHomePage("invoice.failed"), 4000);
