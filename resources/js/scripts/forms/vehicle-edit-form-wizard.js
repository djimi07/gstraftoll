    ...
    $(modernWizard)
      ...
      .on("click", function () {
        ...
        (() => {
          ...
          vehicleSize.removeClass("is-invalid");
        ...
        (() => {
          ...
          if (vehicleSize.val() == "") {
            vehicleSize.addClass("is-invalid");
            error += 1;
          }
        ...
        if (error == 0) {
          ...
          $.post({
            ...
            success: function (response) {
              ...
              if (response.description == "Updated the vehicles") {
    ...
    $(modernWizard)
      ...
      .on("click", function (e) {
        ...
        if (errors == 0) {
          ...
          $.post({
            url:
              "/v1/vehicle/edit/documents/" +
              $('input[name="documentId"]').val(),
            contentType: "application/json",
            data: payload,
            headers: {
              "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
            ...
            success: function (response) {
              ...
              if (response.statusCode == 500) {
                alert(
                  "Internal server error, code: 500, unable to update documents"
                );
              } else if (response.description == "Updated the document") {
